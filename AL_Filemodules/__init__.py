...
class FileBackupManager():
    ...
    """
    @staticmethod
    def cleanupdecor(func: typing.Callable):
    ...
    def __init__(self, file: str, backup: str|pathlib.Path|None=None, mkdirs: bool = False, overwrite: bool = False, removebackup: bool = False):
    ...
    def cleanup(self,exception: Exception|None = None):
    ...
    @cleanupdecor
    def __enter__(self)->pathlib.Path|typing.IO:
    ...
    def __exit__(self,exc_type: typing.Type[Exception]|None,exc_value: Exception|None, traceback: types.TracebackType|None):
...
def _iterdir_re_args(pathobj: pathlib.Path|str, regexobj: re.Pattern|str, test: typing.Callable|None)-> typing.Tuple[pathlib.Path, re.Pattern, typing.Callable]:
    ...
    elif not isinstance(regexobj, re.Pattern): raise ValueError("iterdir_re requires string or Pattern for regex")
...
def iterdir_re(pathobj: pathlib.Path|str, regexobj: re.Pattern|str, test: typing.Callable|None = pathlib.Path.is_file, as_string: bool = False, recurse: bool = False, access_errors: bool = False)-> typing.Generator[pathlib.Path|str,None,None]:
    ...
    regexobj should be a regex-compilable string or an re Pattern object (the result of compile)
    ...
    def iterdir(path: pathlib.Path)-> typing.Generator[pathlib.Path|str,None,None]:
        try:
...
def recurse_directory(directory: pathlib.Path|str, returnmethod: typing.Literal["file", "directory"]|typing.Callable="file", skip_unaccess: bool = True)-> typing.Generator[pathlib.Path,None,None]:
...
def threaded_iterdir_re(pathobj: pathlib.Path|str, regexobj: re.Pattern, *, test: typing.Callable = pathlib.Path.is_file, as_string: bool = False,
                        recurse: bool = False, access_errors: bool = False, threads: int = 6)-> list[pathlib.Path|str]:
    ...
    threadpool: typing.List[typing.Tuple[threading.Event, threading.Thread]] = []
    ...
    def worker(endsignal: threading.Event, mysignal: threading.Event):
...
def index_directory(directory: str|pathlib.Path, recurse:bool = False)->dict:
    ...
    out: dict = dict(Name = directory.name, Path = directory, Symlink = directory == directory.resolve(), Children = list(), Error = None)
    try:
...
def chunkfile(fp: typing.IO, chunksize:int = 1024)-> typing.Generator[bytes,None,None]:
